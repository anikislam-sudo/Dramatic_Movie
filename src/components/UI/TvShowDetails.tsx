...
const TvShowDetails = ({ data, id }: { data: Movie, id: number }) => {
    const { name, number_of_seasons, number_of_episodes, backdrop_path, poster_path, overview, homepage } = data;
    console.log("ff",data);
    ...
    return (
      ...
      <div className="container mx-auto flex flex-col space-y-2 py-4 md:space-y-4 lg:h-[65vh] lg:justify-end lg:pb-12">
        <h1 className="text-2xl font-bold md:text-4xl lg:text-5xl text-white">{name}</h1>
