...
const Footer = () => {
    return (
        <div className="bg-black dark:bg-gray-900">
            <footer className="w-full p-4 py-6 lg:py-8">
                <div className="container mx-auto md:flex md:justify-between">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 sm:gap-6">
                        <div className="mb-6 md:mb-0">
                            <h2 className="text-sm font-semibold text-white uppercase dark:text-white">Navigation</h2>
                        ...
                        <div className="mb-6 md:mb-0">
                            <h2 className="text-sm font-semibold text-white uppercase dark:text-white">Follow us</h2>
                            <ul className="text-gray-500 dark:text-gray-400 font-medium">
                                <li className="mb-4">
                        ...
                        <div className="mb-6 md:mb-0">
                            <h2 className="text-sm font-semibold text-white uppercase dark:text-white">Legal</h2>
                            <ul className="text-gray-500 dark:text-gray-400 font-medium">
                                <li className="mb-4">
                ...
                <div className="text-center">
                    <span className="text-sm text-gray-500 dark:text-gray-400">
                        © 2023 <a href="https://flowbite.com/" className="hover:underline">Dramatic™</a>. All Rights Reserved.
                    </span>
                </div>
