...
const Banner = () => {
  ...
  const gradientBackground = {
    backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.8), rgba(255, 255, 255, 0.3)), url(${baseUrl}${
      ...
      {movie && (
        <div className="relative  h-[95vh] w-screen" style={gradientBackground}>
          <div className=" container mx-auto flex flex-col space-y-2 py-4 md:space-y-4 lg:h-[65vh] lg:justify-end lg:pb-12">
            <h1 className=" titles   text-2xl font-bold md:text-4xl lg:text-5xl text-white">
              
              {movie.title}
            </h1>
            <p className="max-w-xs text-sm sm:pt-2 text-shadow-md md:max-w-lg md:text-lg lg:max-w-4xl lg:text-lg text-white">
              {movie.overview}
            </p>
            ...
            <div className="flex flex-col space-y-3 mt-4 md:flex-row md:space-x-3 md:items-center">
              ...
              <button className="md:w-auto rounded-full bannerButton bg-[#5C5C5C] text-white">
